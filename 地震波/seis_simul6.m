...
function [P,rho,V,K,input,x_xl,z_xl,t_xl,uz3,uz2,uz1,uy3,uy2,uy1,ux3,ux2,ux1]=seis_simul6(m,n,T)
...
rho=readstruct('model/11.png',M,N,1500,3000,-1);
V=v_distrb(M,N)/1.5;
V=readstruct('model/11.png',M,N,2500,4500,-1);
K=V.^2.*rho;

% 点震源信号参数
f0=30;A=5;
x0=M/2;z0=floor(100);t0id=3;
% 基础参数：压力张量，时空序列，震源信号
P=zeros(M,N,T/10);
P1=zeros(M,N);
P2=P1;P3=P1;
